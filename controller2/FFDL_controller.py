...
class FFDL_controller:
    ...
    def init(self):
        self.heading_controllers=[PID(P=0.5,I=0.1,D=0.2,sample_time=self.sample_time,maximum=0.7,minimum=-0.7) for i in range(self.N)]
    ...
    def update_state(self,temp,new_poses,twists):
        ...
        thruster_commands=[0.8]+thruster_commands
